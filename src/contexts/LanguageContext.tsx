...
const translations = {
  pt: {
    ...
    "trainer.disclaimer": "⚠️ Este treinador virtual é apenas informativo e educacional. Não substitui a orientação de profissionais formados em Educação Física, Nutrição ou Medicina. Consulte sempre um especialista antes de iniciar qualquer programa de exercícios ou dieta.",
  ...
  en: {
    ...
    "trainer.disclaimer": "⚠️ This virtual trainer is for informational and educational purposes only. It does not replace guidance from licensed Physical Education, Nutrition, or Medical professionals. Always consult a specialist before starting any exercise or diet program.",
